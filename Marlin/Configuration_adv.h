 ...
 */
  ...
  #if AXIS_IS_TMC(Y)
    #define Y_CURRENT       1100 // Raised for beefy Y motor
  ...
  #if AXIS_IS_TMC(Z)
    #define Z_CURRENT       1200 // Raised for 2 Z motors in parallel
  ...
  #if AXIS_IS_TMC(E0)
    #define E0_CURRENT      600 //800 // Lowered for creality sprite pro
    #define E0_MICROSTEPS    16
   ...
   */
  #define SQUARE_WAVE_STEPPING // TEST THIS
