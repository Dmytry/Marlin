...
#define STRING_CONFIG_H_AUTHOR "Dmitry" // Who made the changes.
...
#define Z_MAX_ENDSTOP_INVERTING false // set to true to invert the logic of the endstop.#define X_MIN_ENDSTOP_INVERTING false // Set to true to invert the logic of the endstop.
#define Y_MIN_ENDSTOP_INVERTING false // Set to true to invert the logic of the endstop.
#define Z_MIN_ENDSTOP_INVERTING false // Set to true to invert the logic of the endstop.
...
#define DEBUG_LEVELING_FEATURE
  ...
  // Do not use fade height, it distorts corners and there's some kind of bug
