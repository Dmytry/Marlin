 ...
 */
  ...
  + ENABLED(Z_PROBE_SIDE_RACK) \
  + ENABLED(Z_PROBE_SIDE_PUSHER)
  #error "Please enable only one probe option: PROBE_MANUALLY, SENSORLESS_PROBING, BLTOUCH, FIX_MOUNTED_PROBE, NOZZLE_AS_PROBE, TOUCH_MI_PROBE, SOLENOID_PROBE, Z_PROBE_ALLEN_KEY, Z_PROBE_SLED, Z_PROBE_SIDE_RACK, Z_PROBE_SIDE_PUSHER, or Z Servo."
#endif
